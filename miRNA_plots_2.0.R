...
mirna <- read.table("~/Dropbox/temp/miRNA/combined_by_mir_overlap/overlap.snps.named.txt", sep = "\t")
...
ggplot(mirna, aes(x=V32)) + 
  ...
  ggtitle("Number of variants predicted to fall within a miRNA binding element predicted by both TargetScan and miRanda")
