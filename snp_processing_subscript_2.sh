...
java -jar ~/java/snpEff/SnpSift.jar filter "(((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'MBL2')) |  ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'ENSECAG00000023001')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'SFTPA1')) | (CHROM = 'chr1') && ((POS > 88956555) && (POS < 89006558)) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'COLEC10')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'COLEC11')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'COLEC12')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'ENSECAG00000000436')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'ENSECAG00000024620')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'FCN3')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'ENSECAG00000008259')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'MASP2')))" $1.lectins.50kb.vcf > $dir/$1.all.$dir.snps.vcf

java -jar ~/java/snpEff/SnpSift.jar filter "(((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'MBL2')) |  ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'ENSECAG00000023001')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'SFTPA1')) | (CHROM = 'chr1') && ((POS > 88956555) && (POS < 89006558)) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'COLEC10')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'COLEC11')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'COLEC12')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'ENSECAG00000000436')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'ENSECAG00000024620')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'FCN3')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'ENSECAG00000008259')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'MASP2')))" $1.lectins.normals.50kb.vcf > $dir/$1.normals.$dir.snps.vcf

java -jar ~/java/snpEff/SnpSift.jar filter "(((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'MBL2')) |  ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'ENSECAG00000023001')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'SFTPA1')) | (CHROM = 'chr1') && ((POS > 88956555) && (POS < 89006558)) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'COLEC10')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'COLEC11')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'COLEC12')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'ENSECAG00000000436')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'ENSECAG00000024620')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'FCN3')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'ENSECAG00000008259')) | ((ANN[*].EFFECT has '$type') && (ANN[*].GENE = 'MASP2')))" $1.lectins.diseased.50kb.vcf > $dir/$1.diseased.$dir.snps.vcf
echo done.
